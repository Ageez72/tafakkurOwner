...
import ArticlesListingItem from "@/components/sections/ArticlesListingItem";
                ...
                <div className='container custom-container'>
                    <div className="row">
                        <div className="col-lg-7">
                            {
                                 newsData && newsData?.articles?.data?.map((news) => (
                                    <Fragment key={news.id}>
                                        <ArticlesListingItem id={news.slug} title={news.title} date={news.date} categories={news.categories} cover={news.image} desc={news.desc} />
                                    </Fragment>
                                ))
                            }
